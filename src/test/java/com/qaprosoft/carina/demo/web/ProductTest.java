...
import com.qaprosoft.carina.demo.gui.web.pages.ConfirmedOrderPage;
import com.qaprosoft.carina.demo.gui.web.pages.OrderSummaryPage;
import com.qaprosoft.carina.demo.gui.web.pages.PaymentPage;
import com.qaprosoft.carina.demo.gui.web.pages.ProductPage;
import com.qaprosoft.carina.demo.gui.web.pages.ShippingPage;
...
public class ProductTest extends BaseTest {
    ...
    public void testProduct() throws InterruptedException {
        ...
        AddressPage addressPage = webLogin(R.TESTDATA.get("test_login_value"), 
